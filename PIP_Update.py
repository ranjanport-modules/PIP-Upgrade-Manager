...
label1 = tk.Label(root, text='PIP Update Manager', bg = 'lightsteelblue2')
...
button1 = tk.Button(text='      Upgrade      ', command=upgradePIP, bg='green', fg='white', font=('helvetica', 12, 'bold'))
